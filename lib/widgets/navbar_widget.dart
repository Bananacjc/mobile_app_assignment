...
class NavbarWidget extends StatelessWidget {
  ...
  const NavbarWidget({super.key, required this.size, required this.currentIndex, required this.onTap});
            ...
            child: Container(
              ...
              child: SizedBox(
                ...
                child: FloatingActionButton(
                  ...
                  elevation: 0.1,
                  shape: CircleBorder(),
                  child: Icon(Icons.house_outlined, color: currentIndex == 1 ? AppColor.accentMint : AppColor.darkCharcoal, size: 28),
                ),
              ),
            ),
          ),
